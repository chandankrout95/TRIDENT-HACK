...
const IncomingCallScreen = () => {
  ...
  useEffect(() => {
    ...
    const onEnded = () => {
      if (!answeredRef.current) navigation.goBack();
    };
...
const styles = StyleSheet.create({
  ...
  callerName: { color: '#F1F5F9', fontSize: 30, fontWeight: 'bold' },
  callType: { color: '#94A3B8', fontSize: 16, fontWeight: '500', marginTop: 8 },
