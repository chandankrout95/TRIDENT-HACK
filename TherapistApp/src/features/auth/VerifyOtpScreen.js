    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.button, isLoading && styles.buttonDisabled]}
          onPress={handleVerify} disabled={isLoading} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  backBtn: { position: 'absolute', top: 50, left: 20, width: 44, height: 44, borderRadius: 14, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, elevation: 2, zIndex: 10 },
  headerSection: { alignItems: 'center', marginBottom: 40 },
  iconBadge: { width: 56, height: 56, borderRadius: 16, backgroundColor: '#ECFDF5', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  title: { fontSize: 28, fontWeight: '800', color: '#1E1B4B', marginBottom: 8 },
  subtitle: { fontSize: 15, color: '#6B7280' },
  emailText: { fontSize: 15, color: '#7C3AED', fontWeight: '600', marginTop: 4 },
  otpContainer: { flexDirection: 'row', justifyContent: 'center', gap: 10, marginBottom: 32 },
  otpInput: { width: 48, height: 56, borderRadius: 14, backgroundColor: '#FFF', borderWidth: 2, borderColor: '#E5E7EB', fontSize: 22, fontWeight: '700', color: '#1E1B4B', shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, elevation: 1 },
  otpInputFilled: { borderColor: '#7C3AED', backgroundColor: '#F5F3FF' },
  button: { backgroundColor: '#10B981', padding: 16, borderRadius: 14, alignItems: 'center', shadowColor: '#10B981', shadowOpacity: 0.35, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 6 },
  buttonDisabled: { opacity: 0.7 },
  buttonText: { color: '#FFF', fontSize: 17, fontWeight: '700' },
  resendSection: { alignItems: 'center', marginTop: 24 },
  resendTimer: { color: '#9CA3AF', fontSize: 14 },
  resendLink: { color: '#7C3AED', fontSize: 14, fontWeight: '700' },
});
